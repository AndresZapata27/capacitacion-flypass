...
import com.jamiltonquintero.solid.l.sinl.casoDos.model.Client;
import com.jamiltonquintero.solid.l.sinl.casoDos.model.ClientRepository;
...
public class ReporteCliente implements IReporte {
    ...
    public ReporteCliente(ClientRepository clientRepository) {
    ...
    public void totalCredito(Document document) throws DocumentException {
        ...
        Paragraph titleParagraph = new Paragraph("Tu total de credito es" + clients.size(), conclusion);
        titleParagraph.setAlignment(Element.ALIGN_CENTER);
        titleParagraph.setSpacingBefore(document.getPageSize().getHeight() / 2 - conclusion.getSize());
        document.add(titleParagraph);
    }
    ...
    public void auditoria(Document document) throws DocumentException {
        throw new RuntimeException("Metodo no soportado para empleados");
    }
}
